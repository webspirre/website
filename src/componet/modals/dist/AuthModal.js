                            ...
                            react_2["default"].createElement(react_1.DialogPanel, { className: "w-full max-w-full md:max-w-xl transform overflow-hidden rounded-none sm:rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all" },
                                ...
                                react_2["default"].createElement("div", { className: "flex flex-col gap-y-4 justify-center items-center w-full" },
                                    ...
                                    react_2["default"].createElement("div", { className: "flex flex-col justify-center items-center sm:flex-row gap-3 w-full max-w-[70%] mx-auto p-4" },
                                        react_2["default"].createElement("button", { className: "w-full sm:w-auto p-2.5 bg-white text-black text-xs font-medium border border-black rounded-lg hover:bg-gray-200 transition duration-300 ease-in-out", onClick: toogleModal }, "Cancel"),
                                        react_2["default"].createElement(link_1["default"], { href: "/auth/register", className: "w-full sm:w-auto p-2.5 bg-black text-white text-xs font-medium border border-black rounded-lg hover:bg-gray-800 transition duration-300 ease-in-out" }, "Sign up")),
