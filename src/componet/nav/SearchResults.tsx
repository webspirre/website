...
const SearchResults: React.FC<SearchResultsProps> = ({ searchResults }) => {
  return (
    <div className="absolute items-center justify-center mt- p-4 px-[50px] z-10 w-[600px] bg-white border-l border-r border-b border-[#BBBBBB] rounded-b-md shadow-md ">
