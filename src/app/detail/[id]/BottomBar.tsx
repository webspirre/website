...
interface BottomBarProp {
  ...
  showBookmarkPopup: boolean;
  handleMoreButtonClick: () => void;
  handleBookmarkButtonClick: () => void;
}
const BottomBar: FC<BottomBarProp> = ({
    ...
    <div className="fixed bottom-0 left-0 w-full bg-white border-t border-[#94A3B8] flex md:hidden justify-between py-2 px-4">
      <div className="flex space-x-2">
        <div className="flex items-center ">
          {/* Bookmark button */}
          <div
            className="p-3 bg-[#F1F0EE] border border-[#94A3B8] rounded-lg"
        ...
        <div className="flex items-center">
          {/* More Option button */}
          <div
            className="py-5 px-3 bg-[#F1F0EE] border border-[#94A3B8] rounded-lg"
